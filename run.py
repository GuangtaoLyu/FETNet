...
def run():
    ...
    parser.add_argument('--gt_root', type=str,default='/home/lgt/下载/dataset/syn_test/label')
    parser.add_argument('--mask_root', type=str,default='/home/lgt/下载/dataset/syn_test/mask')
    parser.add_argument('--text_root', type=str,default='/home/lgt/下载/dataset/syn_test/img')
    ...
    parser.add_argument('--model_path_g', type=str, default="checkpoint/g_200000.pth")
    parser.add_argument('--model_path_d', type=str, default="checkpoint/d_200000.pth")
    ...
    if args.test:
        ...
        print("Number of parameter: %.2fM" % (total2 / 1e6))
